...
class TournamentTest extends PHPUnit\Framework\TestCase
{
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testHeaderOnlyNoTeams");
        fwrite(STDERR, "===================\n");
        $scores   = '';
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testWinIsThreePointsLossIsZeroPoints");
        fwrite(STDERR, "===================\n");
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testWinCanAlsoBeExpressedAsALoss");
        fwrite(STDERR, "===================\n");
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testDifferentTeamsCanWin");
        fwrite(STDERR, "===================\n");
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testADrawIsOnePointEach");
        fwrite(STDERR, "===================\n");
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testThereCanBeMultipleMatches");
        fwrite(STDERR, "===================\n");
        $scores =
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testThereCanBeMoreThanOneWinner");
        fwrite(STDERR, "===================\n");
        $scores =
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testThereCanBeMoreThanTwoTeams");
        fwrite(STDERR, "===================\n");
        $scores =
            "Allegoric Alaskans;Blithering Badgers;win\n" .
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testStandardInput");
        fwrite(STDERR, "===================\n");
        $scores =
            "Allegoric Alaskans;Blithering Badgers;win\n" .
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testIncompleteCompetitionWhereNotAllGamesPlayed");
        fwrite(STDERR, "===================\n");
        $scores =
            "Allegoric Alaskans;Blithering Badgers;loss\n" .
    ...
    {
        fwrite(STDERR, "\n===================");
        fwrite(STDERR, "TEST testTiesSortedAlphabetically");
        fwrite(STDERR, "===================\n");
        $scores =
